...
const projects = [
  {
    ...
    description: "Plataforma de e-commerce completa com carrinho, checkout e painel administrativo. Desenvolvida com foco em performance e SEO.",
  ...
  {
    title: "Design System",
    description: "Sistema de design completo com mais de 50 componentes reutilizáveis, documentação interativa e tokens customizáveis.",
  ...
  },
  {
    ...
    description: "Aplicativo de gerenciamento de tarefas com drag-and-drop, colaboração em tempo real e integrações com APIs externas.",
